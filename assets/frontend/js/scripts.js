...
function initLambert() {
    "use strict";
    $(".loader").delay(2900).fadeIn(4000, function() {
        $("#main").animate({
            opacity: "1"
        }, 500);
    });
    ...
    $(".header-inner .container-fluid").append('<div class="nav-button-holder"><div class="nav-button vis-m"><span></span><span></span><span></span></div></div>');
